         ...
         <div class="row">
            <div class="col-md-3">
               <div class="category-title bg-main">
                  ...
                  <img class="img-fluid d-none d-md-block" src="public/images/category/thoi-trang-nam.png" alt="category.jpg">
               </div>
            </div>
            <div class="col-md-9">
               <div class="row product-list">
                  <div class="col-6 col-md-3 mb-4">
                     <div class="product-item border">
                        <div class="product-item-image">
                           <a href="index.php?option=product">
                        ...
                        <h2 class="product-item-name text-main text-center fs-5 py-1">
                           <a href="index.php?option=product">Thời trang nam 1</a>
                        </h2>
                  ...
                  <div class="col-6 col-md-3 mb-4">
                     <div class="product-item border">
                        ...
                        <h2 class="product-item-name text-main text-center fs-5 py-1">
                           <a href="index.php?option=product">Thời trang nam 2</a>
                        </h2>
                        <h3 class="product-item-price fs-6 p-2 d-flex">
                           <div class="flex-fill"><del>200.000đ</del></div>
                           <div class="flex-fill text-end text-main">190.000đ</div>
               ...
               <div class="row product-list">
                  <div class="col-6 col-md-3 mb-4">
                     <div class="product-item border">
                        <div class="product-item-image">
                           <a href="index.php?option=product">
                              <img src="public/images/product/thoi-trang-nu-1.jpg" class="img-fluid" alt="" id="img1">
                              <img class="img-fluid" src="public/images/product/thoi-trang-nu-2.jpg" alt="" id="img2">
                           </a>
                        </div>
                        <h2 class="product-item-name text-main text-center fs-5 py-1">
                           <a href="index.php?option=product">Thời trang nữ 1</a>
                        </h2>
                        <h3 class="product-item-price fs-6 p-2 d-flex">
                           <div class="flex-fill"><del>200.000đ</del></div>
                           <div class="flex-fill text-end text-main">190.000đ</div>
         ...
         <div class="row">
            <div class="col-md-3">
               <div class="category-title bg-main">
                  ...
                  <img class="img-fluid d-none d-md-block" src="public/images/category/thoi-trang-tre-em.png" alt="">
               </div>
            </div>
            <div class="col-md-9">
               <div class="row product-list">
         ...
         <div class="row">
            <div class="col-md-3">
               <div class="category-title bg-main">
                  ...
                  <img class="img-fluid d-none d-md-block" src="public/images/category/thoi-trang-the-thao.png" alt="">
               </div>
            </div>
            <div class="col-md-9">
               <div class="row product-list">
                  <div class="col-6 col-md-3 mb-4">
                     <div class="product-item border">
                        <div class="product-item-image">
                           <a href="index.php?option=product">
                              <img src="public/images/product/thoi-trang-the-thao-1.webp" class="img-fluid" alt="" id="img1">
                              <img class="img-fluid" src="public/images/product/thoi-trang-the-thao-2.webp" alt="" id="img2">
                           </a>
                        </div>
                        <h2 class="product-item-name text-main text-center fs-5 py-1">
                           <a href="index.php?option=product">Thời trang thể thao 1</a>
                        </h2>
                        <h3 class="product-item-price fs-6 p-2 d-flex">
                           <div class="flex-fill"><del>200.000đ</del></div>
                           <div class="flex-fill text-end text-main">190.000đ</div>
